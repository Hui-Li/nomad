...
int main(int argc, char **argv) {
    ...
    option_desc.add_options()
            ...
            ("ncol", boost::program_options::value<int>(&num_cols)->default_value(17770),
             "number of columns")
            ("rowfile", boost::program_options::value<string>(&row_filename)->default_value(
                    "../Results/synth/netflix_rowdegree.txt"),
             "location of row degree frequencies file")
            ("colfile", boost::program_options::value<string>(&col_filename)->default_value(
                    "../Results/synth/netflix_coldegree.txt"),
